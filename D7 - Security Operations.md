...
* Continuous monitoring - this is a strategy.  NIST 800-137 provides a plan for implementing continuous monitoring that provides visibility of assets, awareness of threats/vulnerability, and security controls deployed.
...
* Privileged account management - privilege keep tends to happen over time. need to ensure there is great justification always to have administrative privileges.  administrative actions are logged.
...
Apply deterrents, monitoring, and protecting to keep assets undamaged and tracked.  Put in GPS tracking, bag inspections, and scanners
* Media management
...
* Response - need to determine an appropriate response.  analyzed all of the material before making a decision
...
* Firewalls - makes sure the right type of traffic is allowed in and out
  ...
  * Next-gen - Stateful packet inspect, and deep packet inspection
...
* Personnel - make sure trained personnel are in charge and correct personnel are alerted
* Communications - super hard to always update necessary personnel in status of what's going on
* Assessment - assess if the current plan covers most all scenarios
* Restoration - procedure for how to recover/restore from a failures? Hard drive RAID recovery time.
* Training and awareness - personnel should be properly trained and aware of what can happen
...
Identify and prioritize critical IT systems and components. there are templates for this
...
* Travel - what material can they carry with them? how can they safely work? safe means of travel/escape?
* Security training and awareness
* Emergency management - what to do if asset is lost? stolen? in danger?
